        ...
        ZStack {
            ...
            VStack() {
                ...
                HStack {
                    ...
                    Text("\(viewModel.ownerUsername)'s post")
...
struct DedicatedPostView_Previews: PreviewProvider {
    static var previews: some View {
        DedicatedPostView(post: Post.example)
    }
}
